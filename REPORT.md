...
- Nguồn đối chiếu: bộ nhãn đối chiếu do người hướng dẫn thực hành cấp
...
- Số hộp needs_review trước và sau khi kiểm: Trước khi kiểm có 7 hộp, sau khi kiểm tra lại thì xử lý xong hết còn 0 hộp.
- Một quyết định chưa đủ bằng chứng và cách bạn xin hỗ trợ: Có một xe ở góc xa ngã tư bị bóng râm che tối và hơi mờ, chưa rõ là xe hatchback hay xe van nhỏ. Tôi đánh dấu needs_review, sau đó zoom to lên so kích thước với xe đi cùng làn thấy ngang cỡ xe 4 chỗ nên gán nhãn car.
...
- Dự đoán đó gợi ý cần kiểm lại quy tắc hoặc dữ liệu nào? Mô hình hay bỏ sót mấy xe ở xa và xe bị che khuất, cho thấy dữ liệu cần được gán kỹ hơn ở các trường hợp bị che và các xe nhỏ ở mép ngoài.
- Minh chứng nào có thể bác bỏ nhận định của bạn? Cần test thêm trên nhiều ảnh khác chụp ở góc máy khác xem mô hình có thực sự bị yếu phần đó không hay do ảnh này ở góc xa bị mờ quá.
